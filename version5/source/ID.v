...
module ID(
	 ...
	 * instructions		DIV
	 * type				hilo
	 * detail			{hi, lo} <- signed(rs / rt)
	 * inst[31:26]	==	6'b000000
	 * inst[25:21]	==	rs
	 * inst[20:16]	==	rt
	 * inst[15:0]	==	16'b0000_0000_0001_1010
	 */
	always@(*) begin
		/* 复位信号rst无效 */
		if((rst == `DISABLE) && (inst[31:26] == 6'b000000) && (inst[15:0] == 16'b0000_0000_0001_1010)) begin
			/* op传递CMD操作码 */
			op <= `CMD_DIV;
			/* a读使能信号，与地址 */
			regaRd <= `ENABLE;
	 ...
	 * inst[25:21]	==	rs
	 * inst[20:16]	==	rt
	 * inst[15:0]	==	16'b0000_0000_0001_1011
	 */
	always@(*) begin
		/* 复位信号rst无效 */
		if((rst == `DISABLE) && (inst[31:26] == 6'b000000) && (inst[15:0] == 16'b0000_0000_0001_1011)) begin
			/* op传递CMD操作码 */
			op <= `CMD_DIVU;
			/* a读使能信号，与地址 */
			regaRd <= `ENABLE;
